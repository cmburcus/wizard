...
module.exports = answers => {
  ...
  const database = [
    {
      ...
      target: `${answers.folderName}/${core.directories.src.config.path}/${
        core.files.config.database
      }`
    },
    {
      template: `${template}/${core.directories.src.database.path}/${
        core.files.database.knexfile
      }.ejs`,
      target: `${answers.folderName}/${core.directories.src.database.path}/${
        core.files.database.knexfile
      }`
    },
    {
      template: `${template}/${core.directories.src.database.path}/${
        core.files.database.migrationStub
      }.ejs`,
      target: `${answers.folderName}/${core.directories.src.database.path}/${
        core.files.database.migrationStub
      }`
  ...
  const app = [
    ...
    },
    {
      ...
      target: `${answers.folderName}/${core.directories.src.config.path}/${
        core.files.config.routes
      }`
    },
    {
      template: `${template}/${core.directories.src.resources.path}/${
        core.files.resources.model
      }.ejs`,
      target: `${answers.folderName}/${core.directories.src.resources.path}/${
        core.files.resources.model
      }`
    },
    {
      template: `${template}/${core.directories.src.resources.path}/${
        core.files.resources.service
      }.ejs`,
      target: `${answers.folderName}/${core.directories.src.resources.path}/${
        core.files.resources.service
      }`
    ...
    {
      template: `${template}/${core.directories.src.resources.path}/${
        core.files.resources.controller
      }.ejs`,
      target: `${answers.folderName}/${core.directories.src.resources.path}/${
        core.files.resources.controller
      }`
  ...
  const misc = [
    ...
    {
      template: `${template}/${utils.directories.errors.types.path}/${
        utils.files.errors.types.authenticationError
      }.ejs`,
      target: `${answers.folderName}/${utils.directories.errors.types.path}/${
        utils.files.errors.types.authenticationError
      }`
    },
    {
      template: `${template}/${utils.directories.errors.types.path}/${
        utils.files.errors.types.invalidArgumentError
      }.ejs`,
      target: `${answers.folderName}/${utils.directories.errors.types.path}/${
        utils.files.errors.types.invalidArgumentError
      }`
    ...
    {
      template: `${template}/${utils.directories.errors.types.path}/${
        utils.files.errors.types.invalidTokenError
      }.ejs`,
      target: `${answers.folderName}/${utils.directories.errors.types.path}/${
        utils.files.errors.types.invalidTokenError
      }`
    ...
    {
      template: `${template}/${utils.directories.errors.types.path}/${
        utils.files.errors.types.notFoundError
      }.ejs`,
      target: `${answers.folderName}/${utils.directories.errors.types.path}/${
        utils.files.errors.types.notFoundError
      }`
    ...
    {
      template: `${template}/${utils.directories.errors.types.path}/${
        utils.files.errors.types.systemError
      }.ejs`,
      target: `${answers.folderName}/${utils.directories.errors.types.path}/${
        utils.files.errors.types.systemError
      }`
    ...
    {
      template: `${template}/${utils.directories.errors.types.path}/${
        utils.files.errors.types.validationError
      }.ejs`,
      target: `${answers.folderName}/${utils.directories.errors.types.path}/${
        utils.files.errors.types.validationError
      }`
    },
    {
      ...
      target: `${answers.folderName}/${utils.directories.filters.path}/${
        utils.files.filters.readme
      }`
    },
    {
      template: `${template}/${utils.directories.filters.path}/${utils.files.filters.index}.ejs`,
      target: `${answers.folderName}/${utils.directories.filters.path}/${
        utils.files.filters.index
      }`
    },
    {
      template: `${template}/${utils.directories.filters.constants.path}/${
        utils.files.filters.constants.filters
      }.ejs`,
      target: `${answers.folderName}/${utils.directories.filters.constants.path}/${
        utils.files.filters.constants.filters
      }`
    },
    {
      template: `${template}/${utils.directories.validator.path}/${
        utils.files.validator.readme
      }.ejs`,
      target: `${answers.folderName}/${utils.directories.validator.path}/${
        utils.files.validator.readme
      }`
    },
    {
      template: `${template}/${utils.directories.validator.path}/${
        utils.files.validator.index
      }.ejs`,
      target: `${answers.folderName}/${utils.directories.validator.path}/${
        utils.files.validator.index
      }`
    ...
    {
      template: `${template}/${utils.directories.validator.config.path}/${
        utils.files.validator.config.joi
      }.ejs`,
      target: `${answers.folderName}/${utils.directories.validator.config.path}/${
        utils.files.validator.config.joi
      }`
    }
  ]
  ...
  const testing = [
    ...
    },
    {
      template: `${template}/${core.directories.src.tests.unit.resources.path}/${
        core.files.tests.unit.resources.model
      }.ejs`,
      target: `${answers.folderName}/${core.directories.src.tests.unit.resources.path}/${
        core.files.tests.unit.resources.model
      }`
    },
    {
      template: `${template}/${core.directories.src.tests.unit.resources.path}/${
        core.files.tests.unit.resources.service
      }.ejs`,
      target: `${answers.folderName}/${core.directories.src.tests.unit.resources.path}/${
        core.files.tests.unit.resources.service
      }`
    ...
    {
      template: `${template}/${core.directories.src.tests.unit.resources.path}/${
        core.files.tests.unit.resources.controller
      }.ejs`,
      target: `${answers.folderName}/${core.directories.src.tests.unit.resources.path}/${
        core.files.tests.unit.resources.controller
      }`
    ...
    {
      template: `${template}/${utils.directories.errors.tests.unit.path}/${
        utils.files.errors.tests.unit.errors
      }.ejs`,
      target: `${answers.folderName}/${utils.directories.errors.tests.unit.path}/${
        utils.files.errors.tests.unit.errors
      }`
    },
    {
      template: `${template}/${utils.directories.filters.tests.unit.path}/${
        utils.files.filters.tests.unit.filters
      }.ejs`,
      target: `${answers.folderName}/${utils.directories.filters.tests.unit.path}/${
        utils.files.filters.tests.unit.filters
      }`
    },
    {
      template: `${template}/${utils.directories.validator.tests.unit.path}/${
        utils.files.validator.tests.unit.validator
      }.ejs`,
      target: `${answers.folderName}/${utils.directories.validator.tests.unit.path}/${
        utils.files.validator.tests.unit.validator
      }`
    }
  ]
