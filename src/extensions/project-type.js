...
module.exports = context => {
  ...
  context.isBackendExpressProject = () => {
    return (
      context.isProject() &&
      JSON.parse(filesystem.read('.wizard')).projectType === projectTypes.backendExpress
    )
  }
  ...
  context.isFrontendReactProject = () => {
    return (
      context.isProject() &&
      JSON.parse(filesystem.read('.wizard')).projectType === projectTypes.frontendReact
    )
  }
  ...
  context.canRunCommand = projectType => {
    ...
    const wrongProject =
      (projectType && !context.isProject()) ||
      (projectType === projectTypes.backendExpress && !context.isBackendExpressProject()) ||
      (projectType === projectTypes.frontendReact && !context.isFrontendReactProject())
